...
public class CruddemoApplication {
	...
	private void readStudent(StudentRepo studentRepo) {
		//create a student object 
			System.out.println("creating new student object ... ");
			Student tempStudent = new Student("Niraj", "Baral", "nirajbaral2@gmail.com");
		...
		Student myStudent = studentRepo.findById(theId);
